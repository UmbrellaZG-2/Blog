...
import com.website.backend.exception.CustomAuthenticationException;
...
public class JwtExceptionHandlerFilter extends OncePerRequestFilter implements Ordered {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            handleException(response, HttpStatus.UNAUTHORIZED,
                    HttpStatusConstants.UNAUTHORIZED, "认证失败: " + e.getMessage());
        } catch (Exception e) {
    ...
    private void handleException(HttpServletResponse response, HttpStatus httpStatus,
